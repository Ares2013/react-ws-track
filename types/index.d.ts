// Type definitions for react-ws-track 2.4
// Project: https://github.com/react-ws-track/react-ws-track
...
export interface WsTrackOptions {
    name?: string;
    clientId?: string;
    sampleRate?: number;
