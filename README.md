# react-ws-track
### React wondershare track Analytics Module
...
[![npm version](https://img.shields.io/npm/v/react-ga.svg?style=flat-square)](https://www.npmjs.com/package/react-ws-track)
[![npm downloads](https://img.shields.io/npm/dm/react-ga.svg?style=flat-square)](https://www.npmjs.com/package/react-ws-track)
...
If you use `react-ws-track` too, we'd love your feedback. Feel free to file [issues, ideas and pull requests against this repo](https://github.com/react-ga/react-ga/issues).
...
* Quite a lot of the code in this repo, came from [react-ga](https://github.com/react-ga/react-ga).
